...
export const metadata: Metadata = {
  title: 'JayCards — Premium Fake IDs',
  description: 'JayCards — the #1 source for premium scannable fake IDs. Serving USA, Canada, UK, Europe and more. Quality guaranteed.',
  icons: {
        ...
        <Script
          ...
          dangerouslySetInnerHTML={{
            __html: `
              ...
              _smartsupp.key = 'fa227b3ac619ea60be89d6805c12cb502bd34245';
