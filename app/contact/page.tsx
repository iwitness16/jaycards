          ...
          <div className="contact-grid">
            ...
            <div className="contact-info">
              ...
              <div className="contact-social">
                <a href="https://wa.me/18166144594" className="social-btn social-wa" aria-label="Chat on WhatsApp" target="_blank" rel="noopener noreferrer">
                ...
                <a href="https://t.me/realjay04" className="social-btn social-tg" aria-label="Message on Telegram" target="_blank" rel="noopener noreferrer">
                ...
                <a href="mailto:orders.jaycards@gmail.com" className="social-btn social-em" aria-label="Send an email">
