...
const ADMIN_WHATSAPP = '18166144594'
const ADMIN_TELEGRAM = 'realjay04'

/* ── All products ── */
const allProducts = [
  // USA — only states with a local image in /public/images/
  { name: 'Alabama Fake ID',                        img: '/images/alabama.jpg',         price: '$100.00' },
  { name: 'Arizona Fake ID',                        img: '/images/arizona.jpg',         price: '$100.00' },
  { name: 'California Fake ID (Teslin)',             img: '/images/california.jpg',      price: '$100.00' },
  { name: 'California Fake ID (Polycarbonate)',      img: '/images/california.jpg',      price: '$100.00' },
  { name: 'Colorado Fake ID',                       img: '/images/colorado.jpg',        price: '$100.00' },
  { name: 'Connecticut Fake ID (Teslin)',            img: '/images/connecticut.jpg',     price: '$100.00' },
  { name: 'Connecticut Fake ID (Polycarbonate)',     img: '/images/connecticut.jpg',     price: '$100.00' },
  { name: 'Delaware Fake ID',                       img: '/images/delaware.jpg',        price: '$100.00' },
  { name: 'Florida Fake ID',                        img: '/images/florida.jpg',         price: '$100.00' },
  { name: 'Georgia Fake ID',                        img: '/images/georgia.jpg',         price: '$100.00' },
  { name: 'Indiana Fake ID',                        img: '/images/indiana.jpg',         price: '$100.00' },
  { name: 'Kansas Fake ID (Teslin)',                 img: '/images/kansas.jpg',          price: '$100.00' },
  { name: 'Kansas Fake ID (Polycarbonate)',          img: '/images/kansas.jpg',          price: '$100.00' },
  { name: 'Maryland Fake ID',                       img: '/images/maryland.jpg',        price: '$100.00' },
  { name: 'Massachusetts Fake ID',                  img: '/images/massachusetts.jpg',   price: '$100.00' },
  { name: 'Michigan Fake ID (Teslin)',               img: '/images/michigan.jpg',        price: '$100.00' },
  { name: 'Michigan Fake ID (Polycarbonate)',        img: '/images/michigan.jpg',        price: '$100.00' },
  { name: 'Minnesota Fake ID (Teslin)',              img: '/images/minnesota.jpg',       price: '$100.00' },
  { name: 'Minnesota Fake ID (Polycarbonate)',       img: '/images/minnesota.jpg',       price: '$100.00' },
  { name: 'Mississippi Fake ID',                    img: '/images/mississippi.jpg',     price: '$100.00' },
  { name: 'Missouri Fake ID (Teslin)',               img: '/images/missouri.jpg',        price: '$100.00' },
  { name: 'Missouri Fake ID (Polycarbonate)',        img: '/images/missouri.jpg',        price: '$100.00' },
  { name: 'Nebraska Fake ID (Teslin)',               img: '/images/nebraska.jpg',        price: '$100.00' },
  { name: 'Nebraska Fake ID (Polycarbonate)',        img: '/images/nebraska.jpg',        price: '$100.00' },
  { name: 'Nevada Fake ID (Teslin)',                 img: '/images/nevada.jpg',          price: '$100.00' },
  { name: 'Nevada Fake ID (Polycarbonate)',          img: '/images/nevada.jpg',          price: '$100.00' },
  { name: 'New Jersey Fake ID (Teslin)',             img: '/images/newjersey.jpg',       price: '$100.00' },
  { name: 'New Jersey Fake ID (Polycarbonate)',      img: '/images/newjersey.jpg',       price: '$100.00' },
  { name: 'New York Fake ID',                       img: '/images/newyork.jpg',         price: '$100.00' },
  { name: 'North Carolina Fake ID (Teslin)',         img: '/images/northcarolina.jpg',   price: '$100.00' },
  { name: 'North Carolina Fake ID (Polycarbonate)',  img: '/images/northcarolina.jpg',   price: '$100.00' },
  { name: 'Ohio Fake ID',                           img: '/images/ohio.jpg',            price: '$100.00' },
  { name: 'Pennsylvania Fake ID (Teslin)',           img: '/images/pennsylvania.jpg',    price: '$100.00' },
  { name: 'Pennsylvania Fake ID (Polycarbonate)',    img: '/images/pennsylvania.jpg',    price: '$100.00' },
  { name: 'Rhode Island Fake ID',                   img: '/images/rhodeisland.jpg',     price: '$100.00' },
  { name: 'South Carolina Fake ID',                 img: '/images/southcarolina.jpg',   price: '$100.00' },
  { name: 'Tennessee Fake ID',                      img: '/images/tennessee.jpg',       price: '$100.00' },
  { name: 'Texas Fake ID',                          img: '/images/texas.jpg',           price: '$100.00' },
  { name: 'Utah Fake ID (Teslin)',                   img: '/images/utah.jpg',            price: '$100.00' },
  { name: 'Utah Fake ID (Polycarbonate)',            img: '/images/utah.jpg',            price: '$100.00' },
  { name: 'Virginia Fake ID',                       img: '/images/virginia.jpg',        price: '$100.00' },
  { name: 'Washington Fake ID',                     img: '/images/washington.jpg',      price: '$100.00' },
  { name: 'Wisconsin Fake ID',                      img: '/images/wisconsin.jpg',       price: '$100.00' },
  // Canada
  { name: 'British Columbia Fake ID',               img: '/images/britishcolumbia.jpg', price: 'CA$100.00' },
  { name: 'Ontario Fake ID',                        img: '/images/ontario.jpg',         price: 'CA$100.00' },
  { name: 'Quebec Fake ID',                         img: '/images/quebec.jpg',          price: 'CA$100.00' },
  { name: 'Alberta Fake ID',                        img: '/images/canada.jpg',          price: 'CA$100.00' },
  { name: 'Manitoba Fake ID',                       img: '/images/canada.jpg',          price: 'CA$100.00' },
  { name: 'Nova Scotia Fake ID',                    img: '/images/canada.jpg',          price: 'CA$100.00' },
  { name: 'Saskatchewan Fake ID',                   img: '/images/canada.jpg',          price: 'CA$100.00' },
  // UK
  { name: 'UK Fake ID — DVLA Photocard (Teslin)',   img: '/images/uk.jpg',              price: '£80.00' },
  { name: 'UK Provisional Licence (Polycarbonate)', img: '/images/uk.jpg',              price: '£80.00' },
  // Germany
...
function OrdersInner() {
  ...
  function buildMessage(orderId: string, submittedAt: string) {
    return [
      ...
      ``,
      `_Sent from JayCards order form_`,
    ].filter(Boolean).join('\n')
  }
  ...
  async function handleSubmit(e: React.FormEvent, channel: 'wa' | 'tg') {
    ...
    // ── 1. Kick off Firestore save and email BEFORE redirect ──
    //    Both are fire-and-forget — they run in the background even after
    //    the user leaves the page via the WhatsApp/Telegram redirect.
    const savePromise = addDoc(collection(db, 'orders'), orderData).catch(console.error)

    // Strip base64 images from the email payload — they blow past sendBeacon's
    // 64 KB limit and aren't needed in the email (admin dashboard has full data).
    ...
    // sendBeacon survives page unload; fall back to fetch if unavailable
    if (navigator.sendBeacon) {
      navigator.sendBeacon(
        '/api/send-order-email',
        new Blob([emailPayload], { type: 'application/json' })
      )
    } else {
      fetch('/api/send-order-email', {
        ...
        body: emailPayload,
        keepalive: true,   // keeps the request alive past page navigation
      }).catch(console.error)
    }

    // ── 2. Open the chosen channel SYNCHRONOUSLY ──
    //    Must happen right after the sync operations above so mobile browsers
    //    don't block window.open (they require it in a direct user-gesture call stack).
    if (channel === 'wa') {
    ...
    // ── 3. Wait for Firestore in the background; reset form when done ──
    //    If the user comes back this cleans up the form.
    //    If they don't, the save already fired in step 1.
    savePromise.then(() => {
      resetForm()
      setSubmitting(false)
    }).catch((err) => {
          ...
          <div className="orders-grid">
            ...
            <form className="orders-form" onSubmit={e => e.preventDefault()}>
              ...
              <div className="form-row">
                ...
                <input type="tel" placeholder="+1 (816) 614-4594" value={whatsapp} onChange={e => setWhatsapp(e.target.value)} required />
              </div>
