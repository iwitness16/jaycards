...
export default function AboutPage() {
  return (
    <>
      <SiteHeader active="About JayCards" />
      <main>
        <PageHeader title="ABOUT JAYCARDS" />

        <div className="about-page shell">

          <h2>Who Is JayCards?</h2>
          <p>
            JayCards is one of the most trusted names in the premium fake ID industry. We have been
          ...
          <p>
            Unlike fly-by-night operations that appear and disappear overnight, JayCards has
          ...
          <p>
            ...
            customers. Always verify you are on the correct JayCards website. We will never ask you
