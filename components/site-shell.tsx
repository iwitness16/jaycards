...
const WA_NUMBER  = '18166144594'
const WA_DISPLAY = '+1 (816) 614-4594'
...
const navLinks = [
  ...
  { label: 'About JayCards', href: '/about' },
  ...
  return (
    <header className="site-header">
      ...
      <div className="shell header-top">
        <Link href="/" className="brand-logo" aria-label="JayCards home">
          ...
          <div className="brand-wordmark">
            <span className="brand-wordmark-name">JayCards</span>
  ...
  return (
    <footer className="site-footer">
        ...
        <div className="shell footer-grid">
          ...
          <div className="footer-col">
            ...
            <div className="footer-logo-wrap">
              <Link href="/" aria-label="JayCards home"
                ...
                <div className="footer-logo-text">
                  <span className="footer-logo-name">JayCards</span>
          ...
          <div className="footer-col footer-about">
            ...
            <p><strong>WhatsApp:</strong> +1 (816) 614-4594</p>
            ...
            <div className="footer-social">
              ...
              <a href={TG_HREF} className="social-btn social-tg" aria-label="Telegram" target="_blank" rel="noopener noreferrer">
              ...
              <a href={`mailto:${MAIL}`} className="social-btn social-em" aria-label="Email">
      ...
      <div className="shell footer-bottom">
        <span>Copyright © 2026, JayCards, All Rights Reserved</span>
      </div>
